...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗗𝗧𝗛𝗢𝗡 - حفـظ الذاتـيـة ♥️](t.me/BDTHON) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
