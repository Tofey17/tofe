...
ZelzalVP_cmd = (
    "𓆩 [𝗕𝗗𝗧𝗛𝗢𝗡 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - أوامـر الفـارات](t.me/BDTHON) 𓆪\n\n"
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد ع الكليشـة مـن القنـاة @BDTHON2 \n\n\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @BDTHON2\n\n"
    ...
    "\n𓆩 [𝗕𝗗𝗧𝗛𝗢𝗡 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/BDTHON3) 𓆪"
)
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if variable in heroku_var:
            await zed.edit("**⎉╎تم تغييـر {} بنجـاح ☑️**\n**⎉╎المتغيـر : ↶**\n `{}` \n**⎉╎يتم الآن إعادة تشغيـل بـوت بــدثــون يستغـرق الأمر 2-1 دقيقـة ▬▭ ...**".format(input_str, vinfo))
        else:
            await zed.edit("**⎉╎تم إضافة {} بنجـاح ☑️** \n**⎉╎المضاف اليه :**\n `{}` \n**⎉╎يتم الآن إعادة تشغيـل بـوت بــدثــون يستغـرق الأمر 2-1 دقيقـة ▬▭ ...**".format(input_str, vinfo))
        ...
        if vinfo.isdigit():
            ...
            return await zed.edit("**⎉╎خطـأ .. قم بالـرد ع رقـم فقـط ؟!**")
        heroku_var[variable] = vinfo
    elif input_str == "نقطة الأوامر" or input_str == "نقطه الأوامر":
        if Config.HEROKU_API_KEY is None:
            return await ed(event, "⎉╎اضبط Var المطلوب في Heroku على وظيفة هذا بشكل طبيعي `HEROKU_API_KEY` إذا كنت لاتعلم اين يوجد فقط اذهب إلى حسابك في هيروكو ثم إلى الإعدادات ستجده بالأسفل انسخه وأدخله في الفار. ")
        ...
        if BOTLOG_CHATID:
                ...
                f"#فتـرة_الايقـاف_المـؤقت_للترحيب\
                        \n**- تم إضافة الفتـرة من الساعة {vinfo} إلى الساعة 6 صباحـاً .. بنجـاح ✓**",
            )
    elif input_str == "ثواني لانهائي" or input_str == "ثواني التجميع" or input_str == "عدد لانهائي":
        variable = "SEC_LAN"
        await asyncio.sleep(1.5)
        if vinfo.isdigit():
            await zed.edit("**⎉╎تم إضافة {} بنجـاح ☑️**\n**⎉╎الثوانـي الجـديـدة** \n {} \n\n**⎉╎الآن قـم بـ ارسـال الأمـر ↶** `.لانهائي` **+ اسم بوت التجميـع لـ البـدء بالتجميـع اللانهائـي . .**".format(input_str, vinfo))
        else:
            return await zed.edit("**⎉╎خطـأ .. قم بالـرد ع رقـم فقـط ؟!**")
        addgvar(variable, vinfo)
    else:
        if input_str:
            return await zed.edit("**⎉╎عـذࢪًا .. لايوجـد هنالك فـار باسـم{} ؟!.. أرسـل (.اوامر الفارات) لـعرض قائمـة الفـارات**".format(input_str))
        return await edit_or_reply(event, "**⎉╎عـذࢪًا .. لايوجـد هنالك فـار باسـم{} ؟!.. أرسـل (.اوامر الفارات) لـعرض قائمـة الفـارات**".format(input_str))
...
async def variable(event):
    ...
    if Config.HEROKU_API_KEY is None:
        return await ed(
            event,
            "⎉╎اضبط Var المطلوب في Heroku على وظيفة هذا بشكل طبيعي `HEROKU_API_KEY` إذا كنت لاتعلم اين يوجد فقط اذهب إلى حسابك في هيروكو ثم إلى الإعدادات ستجده بالأسفل انسخه وأدخله في الفار. ",
        )
    if Config.HEROKU_APP_NAME is not None:
        app = Heroku.app(Config.HEROKU_APP_NAME)
    else:
        return await ed(
            event,
            "⎉╎اضبط Var المطلوب في Heroku على وظيفة هذا بشكل طبيعي `HEROKU_APP_NAME` اسم التطبيق إذا كنت لاتعلم.",
        )
    heroku_var = app.config()
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await asyncio.sleep(1.5)
        if gvarstatus("ALIVE_TEMPLATE") is None:
        	return await zed.edit("**⎉╎عـذࢪًا عـزيـزي .. انت لـم تقـم بإضـافـة فـار {} اصـلاً...**".format(input_str))
        await zed.edit("**⎉╎تم حـذف {} بنجـاح ☑️**\n**⎉╎المتغيـر المحـذوف : ↶**\n `{}` \n**⎉╎يتم الآن إعادة تشغيـل بـوت بــدثــون يستغـرق الأمر 2-1 دقيقـة ▬▭ ...**".format(input_str, variable))
    ...
    elif input_str == "صورة الأوامر" or input_str == "صوره الأوامر":
        variable = "CMD_PIC"
        await asyncio.sleep(1.5)
        ...
        if variable not in heroku_var:
        	return await zed.edit("**⎉╎عـذࢪًا عـزيـزي .. انت لـم تقـم بإضـافـة فـار {} اصـلاً...**".format(input_str))
        await zed.edit("**⎉╎تم حـذف {} بنجـاح ☑️**\n**⎉╎المتغيـر المحـذوف : ↶**\n `{}` \n**⎉╎يتم الآن إعادة تشغيـل بـوت بــدثــون يستغـرق الأمر 2-1 دقيقـة ▬▭ ...**".format(input_str, heroku_var[variable]))
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        variable = gvarstatus("START_BUTUN")
        if variable is None:
            await zed.edit("**⎉╎فـار زر كليشـة ستـارت البـوت غيـر موجـود ❌**\n**⎉╎لـ إضـافته بالـرد ع يـوزرك أو يـوزر قناتـك استخـدم الأمـر : ↶**\n `.اضف فار زر الستارت` \n\n**⎉╎قنـاة السـورس : @BDTHON**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n https://t.me/{}\n\n**⎉╎قنـاة السـورس : @BDTHON**".format(input_str, variable))
        ...
        variable = "OWNER_ID"
        if variable not in heroku_var:
            await zed.edit("**⎉╎فـار ايـدي الحسـاب غيـر موجـود ❌**\n**⎉╎لـ إضـافته بالـرد ع الايـدي فقـط استخـدم الأمـر : ↶**\n `.اضف فار ايدي الحساب` \n\n**⎉╎قنـاة السـورس : @BDTHON**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @BDTHON**".format(input_str, variable))
        ...
        variable = "COMMAND_HAND_LER"
        if variable not in heroku_var:
            await zed.edit("**⎉╎فـار نقطـة الأوامـر غيـر موجـود ❌**\n**⎉╎لـ إضـافته بالـرد ع الرمـز فقـط استخـدم الأمـر : ↶**\n `.اضف فار نقطة الأوامر` \n\n**⎉╎قنـاة السـورس : @BDTHON**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @BDTHON**".format(input_str, variable))
        ...
        variable = "TG_BOT_TOKEN"
        if variable not in heroku_var:
            await zed.edit("**⎉╎فـار توكـن البـوت غيـر موجـود ❌**\n**⎉╎لـ إضـافته بالـرد ع التوكـن فقـط استخـدم الأمـر : ↶**\n `.اضف فار التوكن` \n\n**⎉╎قنـاة السـورس : @BDTHON**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @BDTHON**".format(input_str, variable))
        ...
        variable = "UPSTREAM_REPO"
        if variable not in heroku_var:
            await zed.edit("**⎉╎فـار الريبـو غيـر موجـود ❌**\n**⎉╎لـ إضـافته بالـرد ع رابط السورس الرسمي استخـدم الأمـر : ↶**\n `.اضف فار الريبو` \n\n**⎉╎قنـاة السـورس : @BDTHON**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @BDTHON**".format(input_str, variable))
        ...
        if variable is None:
            await zed.edit("**⎉╎فـار صـورة الأوامـر غيـر موجـود ❌**\n**⎉╎لـ إضـافته بالـرد ع صـورة فقـط استخـدم الأمـر : ↶**\n `.اضف صورة الأوامر` \n\n**⎉╎قنـاة السـورس : @BDTHON**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @BDTHON**".format(input_str, variable))
        ...
        if variable is None:
            await zed.edit("**⎉╎فـار ايموجي/رمز الايدي غيـر موجـود ❌**\n**⎉╎لـ إضـافته بالـرد ع الكليشـة من هنا ( @BDTHON3 ) استخـدم الأمـر : ↶**\n `.اضف كليشة الايدي` \n\n**⎉╎قنـاة السـورس : @BDTHON**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @BDTHON**".format(input_str, variable))
...
async def variable(event):
    ...
    viran = "Asia/Tehran"
    heroku_var = app.config()
    zed = await edit_or_reply(event, "**⎉╎جـاري إعـداد المنطقـة الزمنيـة لـ بــدثــون 🌐...**")
    # All Rights Reserved for "Zed-Thon" "زلـزال الهيبـة"
    if input_str == "العراق" or input_str == "اليمن" or input_str == "سوريا" or input_str == "السعودية" or input_str == "لبنان" or input_str == "الاردن" or input_str == "فلسطين":
        variable = "TZ"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await zed.edit("**⎉╎تم تغييـر المنطقـة الزمنيـة .. بنجـاح ☑️**\n**⎉╎المتغير : ↶**\n دولـة `{}` \n**⎉╎يتم الآن إعادة تشغيـل بـوت بــدثــون يستغـرق الأمر 2-1 دقيقـة ▬▭ ...**".format(input_str))
        else:
...
async def _(malatha):
    if malatha.fwd_from:
        return
    zed = await edit_or_reply(malatha, "**⎉╎جـاري إضافـة فـار الصـورة إلـى بـوتك ...**")
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await zed.edit("**⎉╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**⎉╎المتغيـر : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @BDTHON**".format(input_str, vinfo))
