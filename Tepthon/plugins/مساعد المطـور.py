...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗕𝗗𝗧𝗛𝗢𝗡 - اوامــر المطـور المســاعد](t.me/BDTHON) 𓆪\n\n"
    ...
    "\n𓆩 [ 𐇮 𝑻𝑶𝑭𝑬𝒀 🚸꯭ اࢦـۿــي͟ــٰٰٰٖٖٖۧـ๋͜ـبـ۫͜ـــهٛ ٭꯭ ꯭𓅓ᯓ](t.me/B_8_K) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت بــدثــون 𝗕𝗗𝗧𝗛𝗢𝗡 انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗕𝗗𝗧𝗛𝗢𝗡 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت بــدثــون 𝗕𝗗𝗧𝗛𝗢𝗡 انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
