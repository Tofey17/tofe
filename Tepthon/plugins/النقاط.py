...
ZelzalCoins_cmd = (
    "[ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗕𝗗𝗧𝗛𝗢𝗡 - أوامـر تجميـع النقـاط](t.me/BDTHON) 𓆪\n\n"
    "**⎉╎قـائمـة أوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس بــدثــون 💪 :** \n\n"
    "`.المليار`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت المليـار ( @EEOBot ) .. تلقـائيًــا ✓**\n\n"
    "`.العرب`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت العـرب ( @xnsex21bot ) .. تلقـائيًــا ✓**\n\n"
    "`.دعمكم`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت دعمكـم ( @DamKombot ) .. تلقـائيًــا ✓**\n\n"
    "`.الجوكر`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت الجوكـر ( @A_MAN9300BOT ) .. تلقـائيًــا ✓**\n\n"
    "`.الجنرال`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت العقــاب ( @MARKTEBOT ) .. تلقـائيًــا ✓**\n\n"
    "`.المليون`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت المليــون ( @qweqwe1919bot ) .. تلقـائيًــا ✓**\n\n\n"
    "`.سمسم`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت سمـسـم ( @SMSMWAbot ) .. تلقـائيًــا ✓**\n\n\n"
    "`.تناهيد`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت تناهيـد ( @Ncoe_bot ) .. تلقـائيًــا ✓**\n\n"
    "`.المليار ايقاف`\n"
    ...
    "`.العقاب ايقاف`\n"
    "**⪼ لـ ايقـاف عمليـة تجميـع النقـاط من بوت العقـاب ..**\n\n"
    "`.المليون ايقاف`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- ملاحظـة :**\n"
    "**⪼ سيتم إضـافـة المزيـد من البوتـات بالتحديثـات القادمـة .. اذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @B_8_K**"
)
