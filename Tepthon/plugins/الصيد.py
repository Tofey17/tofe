...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗕𝗗𝗧𝗛𝗢𝗡 - أوامـر الصيد والتشيكـر](t.me/BDTHON) 𓆪\n\n"
    ...
    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن بــدثــون**\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗕𝗗𝗧𝗛𝗢𝗡 - أنـواع اليـوزرات](t.me/BDTHON) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد بــدثــون 𝗕𝗗𝗧𝗛𝗢𝗡 ⎉",

                    about="This channel to hunt username by - @BDTHON ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت بــدثــون 𝗕𝗗𝗧𝗛𝗢𝗡 ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس بــدثــون - @BDTHON ",
