...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت بــدثــون"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝗕𝗗𝗧𝗛𝗢𝗡 ─┄─┄─┄─⋆"
zed_dev = (6799580948, 5943382651)
zel_dev = (6799580948, 5943382651)
zelzal = (6799580948, 5943382651)
