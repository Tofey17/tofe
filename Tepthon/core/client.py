                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @B_8_K\
                                  \n\n--------بـدء تتبـع سجـل بــدثــون 𝗕𝗗𝗧𝗛𝗢𝗡--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع بــدثــون 𝗕𝗗𝗧𝗛𝗢𝗡--------"
                        ...
                        link = "[𐇮 𝑻𝑶𝑭𝑬𝒀 🚸꯭ اࢦـۿــي͟ــٰٰٰٖٖٖۧـ๋͜ـبـ۫͜ـــهٛ ٭꯭ ꯭𓅓ᯓ](https://t.me/B_8_K)"
                        text = (
                            "**✘ تقـريـر إشعـار بــدثــون 𝗕𝗗𝗧𝗛𝗢𝗡 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار بــدثــون 𝗕𝗗𝗧𝗛𝗢𝗡 ✘**\n\n "
                        link = "[𐇮 𝑻𝑶𝑭𝑬𝒀 🚸꯭ اࢦـۿــي͟ــٰٰٰٖٖٖۧـ๋͜ـبـ۫͜ـــهٛ ٭꯭ ꯭𓅓ᯓ](https://t.me/B_8_K)"
