...
LOGS = logging.getLogger("𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗗𝗧𝗛𝗢𝗡 🇮🇶")
cmdhr = Config.COMMAND_HAND_LER
Zed_Vip = (6799580948, 5943382651)
zchannel = {"@BDTHON", "@BDTHON2", "@BDTHON3", "@BDTHON4", "@T33Td"}
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://graph.org/file/75dbf558f43f4a6bf6ff0.mp4",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس بــدثــون الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗗𝗧𝗛𝗢𝗡 🇮🇶", "https://t.me/BDTHON"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
